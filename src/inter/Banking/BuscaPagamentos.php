...
class BuscaPagamentos
{
    private $codBarraLinhaDigitavelQuery = "&codBarraLinhaDigitavel=";
    private $codigoTransacaoQuery = "&codigoTransacao=";
    private $filtrarDataPorQuery = "&filtrarDataPor=";
    private $msg = "Chamada Iniciada - Busca Pagamentos";
    private $errorCallApiMessage = "Erro na Busca de Pagamentos. ";
     ...
     */
    final public function call(string $dataInicio, string $dataFim, string $codBarraLinhaDigitavel = null,
                               string $codigoTransacao = null, string $filtrarDataPor = null): array
    {
        ...
        LogUtils::logMsg(PARAMETROS . LINE_BREAK .
            ...
            COD_BARRA_LINHA_DIGITAVEL . $codBarraLinhaDigitavel . LINE_BREAK .
        ...
        $path = ConfigUtils::getPath(API_TYPE_BANKING, API_ENDPOINT_PATH_PAGAMENTOS);

        $METHOD = $path[METHOD];
        $URL = $baseUrl . $path[ROUTE] . DATA_INICIO_QUERY . $dataInicio . DATA_FIM_QUERY . $dataFim;

        $this->buildQuery($URL, $codBarraLinhaDigitavel, $codigoTransacao, $filtrarDataPor);
    ...
    private function buildQuery(string &$URL, string $codBarraLinhaDigitavel = null,
                                string $codigoTransacao = null, string $filtrarDataPor = null): void
    {
        if ($codBarraLinhaDigitavel !== null) {
            $URL .= $this->codBarraLinhaDigitavelQuery . $codBarraLinhaDigitavel;
        }
