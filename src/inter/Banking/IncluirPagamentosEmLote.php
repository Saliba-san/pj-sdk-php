...
class IncluirPagamentosEmLote
{
    private $msg = "Chamada Iniciada - Incluir Pagamento em Lote";
    private $errorCallApiMessage = "Erro ao Incluir Pagamentos em Lote. ";
     ...
     */
    final public function call(IncluirPagamentoLoteBody $body): stdClass
    {
        ...
        $path = ConfigUtils::getPath(API_TYPE_BANKING, API_ENDPOINT_PATH_INCLUI_PAGAMENTO_LOTE);
    ...
    final public function getBody(IncluirPagamentoLoteBody $body): string
    {
