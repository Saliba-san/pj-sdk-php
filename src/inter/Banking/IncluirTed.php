...
class IncluirTed
{
    private $msg = "Chamada Iniciada - Incluir Ted";
    private $errorCallApiMessage = "Erro ao Incluir Ted. ";
     ...
     */
    final public function call(IncluirTedBody $bodyRequest): stdClass
    {
        ...
        $path = ConfigUtils::getPath(API_TYPE_BANKING, API_ENDPOINT_PATH_INCLUI_TED);
    ...
    final public function getBody(IncluirTedBody $body): string
    {
