...
class IncluirPagamentoDarf
{
    private $msg = "Chamada Iniciada - Incluir Pagamento Darf";
    private $errorCallApiMessage = "Erro ao Incluir Pagamento Darf. ";
     ...
     */
    final public function call(IncluirPagamentoDarfBody $body): object
    {
        ...
        $path = ConfigUtils::getPath(API_TYPE_BANKING, API_ENDPOINT_PATH_INCLUI_PAGAMENTO_DARF);
    ...
    final public function getBody(IncluirPagamentoDarfBody $body): string
    {
