...
class CriarWebhook
{
    private $msg = "Chamada Iniciada - Criar Webhook Banking";
    private $errorCallApiMessage = "Erro ao Criar Webhook do Banking. ";
     ...
     */
    final public function call(string $webhookUrl, string $tipoWebhook): void
    {
        ...
        $path = ConfigUtils::getPath(API_TYPE_BANKING, API_ENDPOINT_PATH_PUT_WEBHOOK);
