...
class Saque implements \JsonSerializable
{
    ...
    /**
     * Construtor da classe Saque.
     *
     * @param string $valor - Obrigatório - Valor do saque efetuado. $valor = "10.00"<p>
     * @param int $modalidadeAlteracao - Opcional - Modalidade de alteração de valor do saque.<p>
    ...
    /**
     * @param string|null $prestadorDoServicoDeSaque
     */
