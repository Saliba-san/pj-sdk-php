...
class ConsultarCobrancaImediata
{
    private $msg = "Chamada Iniciada - Consulta Cobrança Imediata";
    private $errorCallApiMessage = "Erro ao Consultar Cobrança Imediata. ";
     ...
     */
    final public function call(string $txid): stdClass
    {
        ...
        $path = ConfigUtils::getPath(API_TYPE_PIX, API_ENDPOINT_PATH_COBRANCA_IMEDIATA);
