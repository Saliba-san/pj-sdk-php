...
class DesvincularConbrancaLocation
{
    private $msg = "Chamada Iniciada - Desvincular Cobrança de uma Location";
    private $errorCallApiMessage = "Erro ao Desvincular Cobrança de uma Location. ";
    ...
    final public function call(string $id): stdClass
    {
        ...
        $path = ConfigUtils::getPath(API_TYPE_PIX, API_ENDPOINT_PATH_DESVINCULAR_LOCATION);
