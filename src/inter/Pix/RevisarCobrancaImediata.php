...
class RevisarCobrancaImediata
{
    private $msg = "Chamada Iniciada - Revisar Cobrança Imediata";
    private $errorCallApiMessage = "Erro ao Revisar Cobrança Imediata. ";
     ...
     */
    final public function call(CobrancaBody $body, string $txId): stdClass
    {
        ...
        $path = ConfigUtils::getPath(API_TYPE_PIX, API_ENDPOINT_PATH_PATCH_COBRANCA_IMEDIATA);
