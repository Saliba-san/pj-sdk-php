...
class CriarWebhook
{
    private $msg = "Chamada Iniciada - Criar Webhook Pix";
    private $errorCallApiMessage = "Erro ao Criar Webhook do Pix. ";
     ...
     */
    final public function call(string $webhookUrl, string $chave): void
    {
        ...
        $path = ConfigUtils::getPath(API_TYPE_PIX, API_ENDPOINT_PATH_PUT_WEBHOOK);
