...
class CriarCobrancaImediata
{
    private $msg = "Chamada Iniciada - Criar Cobrança Imediata";
    private $errorCallApiMessage = "Erro ao Criar Cobrança Imediata. ";
     ...
     */
    final public function call(CobrancaBody $body): stdClass
    {
        ...
        $path = ConfigUtils::getPath(API_TYPE_PIX, API_ENDPOINT_PATH_POST_COBRANCA_IMEDIATA);
